...
const CG_TIPOS = {
  turnover:      { label: 'Turnover',         emoji: '🧹', icon: 'sparkles', chip: 'bg-blue-100 text-blue-800',       dot: 'bg-blue-500',    bar: '#2f6b4f' },
  ...
  mantenimiento: { label: 'Mantenimiento',    emoji: '🔧', icon: 'wrench',   chip: 'bg-emerald-100 text-emerald-800', dot: 'bg-emerald-500', bar: '#1f7a4d' },
  recado:        { label: 'Recado',           emoji: '🛒', icon: 'package',  chip: 'bg-slate-200 text-slate-700',     dot: 'bg-slate-500',   bar: '#756c5c' },
};
