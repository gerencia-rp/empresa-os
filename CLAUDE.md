...
- Optimización Fix & Flip ya no queda inútil mientras aprende: su ejecutor opera en modo **observabilidad supervisada**, revisando etapas faltantes y frescura de `ff_deals` con evidencia en `agent_audit_log`; solo crea una propuesta si hay problemas. Las medianas y alertas por duración siguen cerradas hasta alcanzar 3 intervalos reales, 2 propiedades y 2 etapas. No reconstruye historia ni convierte baselines en transiciones.
