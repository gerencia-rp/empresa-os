...
- La certificación de ausencia prolongada usa diez compuertas. Además de agentes, cobertura humana, decisiones, ocupación, linaje, QuickBooks, reportes y fallos de cron, exige señal vigente de automatizaciones y cero hallazgos financieros críticos. Mientras una falle, el estado canónico es `no_listo`.
