...
- 🙋 Acciones humanas pendientes (en el log): retirar campos legacy en la UI de Airtable · llenar `clickup_scheduler_plantilla` (activa el auto-scheduler N7) · comprobante required en el form de pagos · N8 carril datos-lectura IA (spec lista).
