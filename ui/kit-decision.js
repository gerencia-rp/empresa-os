...
(function kitDecisionCSS() {
  ...
  st.textContent = [
    '.kit-term{border-bottom:1.5px dotted var(--mut,#8b93a1);cursor:help;position:relative}',
    '.kit-term .kit-term-tip{display:none;position:absolute;left:0;bottom:130%;z-index:1000;width:270px;background:var(--card,#161a20);color:var(--ink,#f1f3f7);border:1px solid var(--line,rgba(128,144,176,.3));border-radius:10px;padding:10px 12px;font-size:11.5px;font-weight:400;line-height:1.45;box-shadow:0 10px 30px rgba(0,0,0,.25);text-transform:none;letter-spacing:0}',
    '.kit-term:hover .kit-term-tip,.kit-term:focus .kit-term-tip{display:block}',
    '.kit-drill{cursor:pointer;border-radius:6px}',
    '.kit-drill:hover{background:color-mix(in srgb, var(--a2,#3a5be0) 10%, transparent)}',
    '.kit-drill-ico{font-size:11px;color:var(--mut,#8b93a1);margin-left:4px;vertical-align:super}',
    ...
    '.kit-drill-panel{background:var(--bg,#12141a);color:var(--ink,#f1f3f7);border:1px solid var(--line,rgba(128,144,176,.3));border-radius:16px;padding:18px 20px;max-width:640px;width:100%;max-height:80vh;overflow:auto;box-shadow:0 20px 60px rgba(0,0,0,.4)}',
    '.kit-next{margin-top:9px;background:color-mix(in srgb, var(--amber,#fbbf24) 9%, transparent);border:1px solid color-mix(in srgb, var(--amber,#fbbf24) 30%, transparent);border-radius:10px;padding:9px 12px}',
    '.kit-kpi{padding:15px 17px}',
    '.kit-kpi-lab{font-size:10.5px;text-transform:uppercase;letter-spacing:.7px;color:var(--mut,#8b93a1);font-weight:800}',
