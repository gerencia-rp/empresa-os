...
function reportOpen(cfg) {
  ...
  const html = '<!doctype html><html><head><meta charset="utf-8"><link href="https://fonts.googleapis.com/css2?family=Fraunces:opsz,wght@9..144,500;9..144,600;9..144,700&display=swap" rel="stylesheet"><title>' + E(cfg.titulo) + ' · Rental Profits</title><style>'
    ...
    + '.logo{font-size:20px;font-weight:800;color:#2b44c6;font-family:Fraunces,Georgia,serif}.logo em{font-style:normal;color:#5c79f0}.logo span{display:block;font-size:9px;letter-spacing:2.2px;color:#98a0ae;font-weight:700;margin-top:2px}'
    + 'h1{font-size:21px;margin:14px 0 2px;font-family:Fraunces,Georgia,serif}.sub{font-size:12px;color:#98a0ae}'
    ...
    + '.k .l{font-size:8.5px;text-transform:uppercase;letter-spacing:.7px;color:#98a0ae;font-weight:800}'
    + '.k .v{font-size:18px;font-weight:800;margin-top:2px;font-variant-numeric:tabular-nums}.k .s{font-size:9.5px;color:#98a0ae;margin-top:1px}'
    ...
    + 'table{border-collapse:collapse;width:100%;font-size:11.5px}th{text-align:left;font-size:9px;text-transform:uppercase;color:#98a0ae;padding:4px 8px;border-bottom:2px solid #dfe4ec}td{padding:5px 8px;border-bottom:1px solid #eef1f6}'
    ...
    + '.nota{font-size:10px;color:#98a0ae;margin-top:7px}'
    ...
    + '<div style="text-align:right;font-size:11px;color:#98a0ae">' + fecha + '</div></div>'
    + '<h1>' + E(cfg.titulo) + '</h1>'
