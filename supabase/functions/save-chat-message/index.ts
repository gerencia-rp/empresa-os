// ════════════════════════════════════════════════════════════════
// save-chat-message · guarda 1 mensaje del Agente en chat_conversations
// ════════════════════════════════════════════════════════════════
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (!body.session_id || !body.role || body.content == null) {
      return corsResponse(req, { error: "Faltan campos: session_id, role, content" }, 400);
    }
