...
-- Voyage voyage-3-lite con output_dimension=512 (Matryoshka). Si se usa OpenAI
-- text-embedding-3-small (1536), recrear la tabla/índice/función con VECTOR(1536).
...
CREATE OR REPLACE FUNCTION match_generations(query_embedding VECTOR(512), match_count INT DEFAULT 5)
RETURNS TABLE (
