...
3. Confirmar la directiva semanal; después revisar Radar, Aprobación y Consejo de Calidad en ese orden.
4. No usar los números ni creatividades de la muestra como material real.
5. En Calendario, usar **Exportar paquete manual** para revisar la estructura de entrega. El archivo no autoriza publicación.
